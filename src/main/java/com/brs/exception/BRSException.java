...
import com.brs.config.PropertiesConfig;
...
public class BRSException {
     ...
     * @return
     */
    public static RuntimeException throwException(EntityType entityType, ExceptionType exceptionType, Long id,
                                                  String... args) {
     ...
     * @return
     */
    public static RuntimeException throwException(ExceptionType exceptionType, String messageTemplate, String... args) {
